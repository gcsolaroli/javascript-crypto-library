...
//Clipperz.Profile.stop("Clipperz.Crypto.SHA.sha256_array");
	...
	'sha256_arrayBuffer': function(aValue) {
//Clipperz.Profile.start("Clipperz.Crypto.SHA.sha256_arrayBuffer");
		var	result;
		var	message;
		var h0, h1, h2, h3, h4, h5, h6, h7;
		var	k;
		...
		message = new Uint8Array(messageLength + 1 + _c + 8);
		...
		//Pre-processing:
//		message.push(0x80);	//	append a single "1" bit to  message
		message[messageLength] = 0x80;	//	append a single "1" bit to  message
